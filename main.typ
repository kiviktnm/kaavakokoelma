...
#t2(
  ...
  [Kondensaattorin kapasitanssi], $ C = Q / V_(a b) $,
  [Suuri levykondensaattori], $ C = epsilon A / d $,
  [Pallokondensaattori], $ C = 4 pi epsilon (r_a r_b) / (r_b - r_a) $,
  [Sylinterikondensaattori], $ C = 2 pi epsilon (L) / ln(r_b / r_a) $,
  [Kondensaattorien sarjaankytkentä], $ 1/C = sum_i^N 1/C_i $,
  [Kondensaattorien rinnankytkentä], $ C = sum_i^N C_i $,
  [Kondensaattorin potentiaalienergia], $ U = Q^2 / (2 C) = 1/2 C V = 1/2 Q V $,
  [Suhteellinen permittiivisyys (kun $C_0$ on tyhjiössä)], $ K = epsilon_r = C / C_0 $,
  [Permittiivisyys], $ epsilon = epsilon_r epsilon_0 $,
  [Sähköenergiatiheys], $ u = 1/2 epsilon E^2 $,
  [Gaussin laki eristeessä], $ integral.cont epsilon_r ar(E) dot dif ar(A) = Q_("encl-free") / epsilon_0 $,
  [Sähkövirta], $ I = (dif Q) / (dif t) $,
  [Virrantiheys (hiukkastiheys $[n]=1/"m"^3$)], $ J &= I / A = n abs(q) v_d \ ar(J) &= n q ar(v)_d $,
  [Ohmin laki (idealisaatio)], $ rho &= E / J \ ar(E) &= rho ar(J) $,
  [Resistanssi (suora johdin)], $ R = (rho L) / A $,
  [Resistanssi], $ R = V / I $,
  [Vastusten sarjaankytkentä], $ R = sum_i^N R_i $,
  ...
  [Magneettivuo], $ Phi_B = integral ar(B) dot dif ar(A) = integral B_perp dif A = integral B cos theta dif A $,
  ...
  [Faradayn induktiolaki (silmukka)], $  cal(E) = - (dif Phi_B) / (dif t) = - dif / (dif t) (integral ar(B) dot dif ar(A)) = integral.cont ar(E) dot dif ar(l) $,
  [Liikkeen tuottama sähkömotorinen voima], $ cal(E) = integral.cont (ar(v) times ar(B)) dot dif ar(l) $,
  [Siirrosvirta], $ i_D = epsilon_0 (dif Phi_E)/(dif t) $,
  [Yleistetty Amperen laki], $ integral.cont ar(B) dot dif(l) = mu_0 (i_C + i_D)_"encl" $,
  [Keskenäisinduktanssi], $ M = (N_2 Phi_(B 2))/i_1 = (N_1 Phi_(B 1))/(i_2) $,
  [(Itseis)induktanssi], $ L = (N Phi_B) / i $,
  [Itseisindusoitunut sähkömotorinen voima], $ cal(E) = -L (dif i)/(dif t) $,
  [Kelan magneettinen energia], $ U = L integral_0^I i dif i = 1/2 L I^2 $,
  [Ideaalimuuntaja], $ V_2 / V_1 = N_2 / N_1 $,
  [Sähkömagneettinen aaltoyhtälö tyhjiössä], $ (partial^2 E_y (x,t)) / (partial x^2) = mu_0 epsilon_0 (partial^2 E_y (x,t))/(partial t^2) $,
  [Sinimuotoisen sm-aallon kenttäratkaisupari], $ ar(E) (x,t) = hat(j) E_"max" cos(k x - omega t) \ ar(B) (x,t) = hat(k) B_"max" cos(k x - omega t) \ E_"max" = c B_"max" $,
  [sm-aallon taitekerroin], $ n = c / v = sqrt(mu_r epsilon_r) approx^(mu_r approx 0) sqrt(epsilon_r) $,
  [sm-aallon energiatiheys tyhjiössä], $ u = u_E + u_B = 1/2 epsilon_0 E^2 + 1/(2 mu_0) B^2 = epsilon_0 E^2 $,
  [Energiavirtaus, Poyntingin vektori], $ ar(S) = 1/mu_0 ar(E) times ar(B) $,
  [Kokonaisteho suljetun pinnan läpi], $ P = integral.cont ar(S) dot dif ar(A) $,
  [Sinimuotoisen ratkaisun Poyntingin vektori], $ ar(S) (x,t) = hat(i) (E_max B_max)/(2 mu_0) [1+cos 2(k x - omega t)] $,
  [Sinimuotoisen aallon intensiteetti tyhjiössä], $ I = S_"av" = (E_max B_max)/(2 mu_0) = E^2_max / (2 sqrt(mu_0 / epsilon_0)) $,
